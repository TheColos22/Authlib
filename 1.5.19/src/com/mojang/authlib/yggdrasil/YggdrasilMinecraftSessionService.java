...
public class YggdrasilMinecraftSessionService
    ...
    public void joinServer(GameProfile profile, String authenticationToken, String serverId)
        ...
        LOGGER.info("DEBUR_1: request: " + request);
    ...
    public Map<MinecraftProfileTexture.Type, MinecraftProfileTexture> getTextures(GameProfile profile, boolean requireSecure) {
        Property textureProperty = (Property) Iterables.find(profile.getProperties().get("textures"), null);
        LOGGER.info("DEBUR_2: textureProperty: " + textureProperty);
        System.out.print("DEBUR_2: textureProperty: " + textureProperty);
